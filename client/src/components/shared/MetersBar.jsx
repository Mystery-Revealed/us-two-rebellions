// MetersBar.jsx — the three 0–100 meters (Order ⚖️, Money 💰, Trust 🏛️). Icons +
// labels + numbers, never color alone. Flashes a +/- chip when a meter changes.
// These are DRAMA (spec §3) — they never decide accuracy.

import { useEffect, useRef, useState } from 'react';

const ICONS = { order: '⚖️', money: '💰', trust: '🏛️' };
  ...
  return (
    <div className={`meters ${compact ? 'compact' : ''}`}>
      ...
      {Object.entries(meters).map(([key, value]) => {
        ...
        const low = value <= 15; // a meter running dangerously low
        return (
