...
app.get('/healthz', (_req, res) =>
  res.json({ ok: true, service: 'us-two-rebellions', liveSessions: manager.registry.sessions.size }));
...
server.listen(config.port, () => {
  console.log(`[us-two-rebellions] listening on :${config.port} — sessions live in memory only`);
});
